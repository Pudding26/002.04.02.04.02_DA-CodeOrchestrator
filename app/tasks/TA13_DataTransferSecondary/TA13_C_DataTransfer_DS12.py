...
from app.utils.SQL.models.production.api.api_DS12 import DS12_Out



class TA13_C_DataTransfer_DS12(TaskBase):
    def setup(self):
    ...
    def run(self):
        try:
            logging.info(f"[{self.dataset_name}] 🚀 Starting DS12 transfer process.")
            ...
            DS12_Out.store_dataframe(self.data_cleaned, db_key="production", method="replace")

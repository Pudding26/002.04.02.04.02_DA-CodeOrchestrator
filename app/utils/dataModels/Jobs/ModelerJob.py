...
from app.utils.dataModels.configs.resampling import ResamplingConfig
from app.utils.dataModels.configs.clustering import ClusterConfig
...
class ModelerAttrs(BaseModel):
    ...
    featureClusterMap: Optional[Dict[str, Any]] = None  # Dict with cluster labels and their features
